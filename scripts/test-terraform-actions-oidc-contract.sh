...
assert_contains "${bootstrap}" '"s3:GetBucketWebsite"' "legacy S3 bucket website 설정 조회 권한이 필요하다."
assert_contains "${bootstrap}" '"s3:GetAccelerateConfiguration"' "legacy S3 bucket accelerate 설정 조회 권한이 필요하다."
assert_contains "${bootstrap}" '"s3:GetBucketRequestPayment"' "legacy S3 bucket request payment 설정 조회 권한이 필요하다."
assert_contains "${bootstrap}" '"s3:GetReplicationConfiguration"' "legacy S3 bucket replication 설정 조회 권한이 필요하다."
assert_contains "${bootstrap}" '"s3:GetBucketObjectLockConfiguration"' "legacy S3 bucket object lock 설정 조회 권한이 필요하다."
